...
<main class="mx-auto flex max-w-[90%] flex-col gap-10 px-0 py-12 md:max-w-[80%] md:px-5">
	<Landing {buttons}>
		{#snippet title()}
			Sup,
		...
		{#snippet long()}
			Outside of coding, I'm an obsessed {@render descLink(
				...
				'gym rat'
			)} &#40;yes, <span class="italic">really</span>&#41;. I also love photography and videography;
